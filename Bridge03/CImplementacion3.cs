...
namespace Bridge03
{
    class CImplementacion3 : IBridge
    {
        ...
        public void MostrarTotales(Dictionary<string, double> pProductos)
        {
            ...
            Console.WriteLine("El total de comida es de ${0}, {1}% del total", totalc, totalc/total*100);
            Console.WriteLine("El total de medicamentos es de ${0}, {1}% del total", totalm, totalm / total * 100);
            Console.WriteLine("El total de deportes es de ${0}, {1}% del total", totald, totald / total * 100);
